...
# Date: Sun, 16 Oct 2016 15:42:19 GMT
#set_units -time ns
...
create_generated_clock -name {ConsolePort_2_Clock_1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 7 13} [list [get_pins {ClockBlock/dclk_glb_0}]]
create_generated_clock -name {ConsolePort_1_Clock_1} -source [get_pins {ClockBlock/clk_sync}] -edges {1 7 13} [list [get_pins {ClockBlock/dclk_glb_1}]]


# Component constraints for C:\Users\Thomas\Documents\PSoC Creator\TASBot\TASBot.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\Thomas\Documents\PSoC Creator\TASBot\TASBot.cydsn\TASBot.cyprj
# Date: Sun, 16 Oct 2016 15:42:14 GMT
