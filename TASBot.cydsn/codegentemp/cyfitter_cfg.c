...
#define BS_UDB_1_3_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000730u)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480007C0u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0 + 0x2u), 0x58u);
