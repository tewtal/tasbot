...
#if !defined(Timer_1_Sync_ctrl_reg__REMOVED)

static Timer_1_BACKUP_STRUCT  Timer_1_backup = {0u};
...
{
    Timer_1_backup.controlState = Timer_1_Control;
}
...
{
     Timer_1_Control = Timer_1_backup.controlState;
}
