...
{
   #if(ConsolePort_1_ClockTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(ConsolePort_1_ClockTimer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG16(ConsolePort_1_ClockTimer_PERIOD_LSB_PTR));
   #endif /* (ConsolePort_1_ClockTimer_UsingFixedFunction) */
}
...
void ConsolePort_1_ClockTimer_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(ConsolePort_1_ClockTimer_PERIOD_LSB_PTR, period);
...
{
   #if(ConsolePort_1_ClockTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(ConsolePort_1_ClockTimer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG16(ConsolePort_1_ClockTimer_CAPTURE_LSB_PTR));
   #endif /* (ConsolePort_1_ClockTimer_UsingFixedFunction) */
}
...
void ConsolePort_1_ClockTimer_WriteCounter(uint16 counter) 
{
    ...
    #else
        CY_SET_REG16(ConsolePort_1_ClockTimer_COUNTER_LSB_PTR, counter);
